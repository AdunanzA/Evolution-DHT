...
namespace HashLib.Crypto.SHA3
{
    ...
    internal abstract class SHAvite3Base : HashCryptoNotBuildIn
    {
        #region Consts
    ...
    internal abstract class SHAvite3_256Base : SHAvite3Base
    {
        ...
        protected override void TransformBlock(byte[] a_data, int a_index)
        {
            ...
            Converters.ConvertBytesToUInts(a_data, a_index, 64, rk, 0);
        ...
        protected override void Finish()
        {
            ...
            if (buf_pos >= BlockSize - 10)
            {
                ...
                Converters.ConvertULongToBytes(m_processedBytes * 8, pad, BlockSize - 10);
    ...
    internal abstract class SHAvite3_512Base : SHAvite3Base
    {
        ...
        protected override void TransformBlock(byte[] a_data, int a_index)
        {
            ...
            Converters.ConvertBytesToUInts(a_data, a_index, 128, rk, 0);
        ...
        protected override void Finish()
        {
            ...
            if (buf_pos >= BlockSize - 18)
            {
                ...
                Converters.ConvertULongToBytes(m_processedBytes * 8, pad, padindex);
                padindex += 16;
            ...
            {
                Converters.ConvertULongToBytes(m_processedBytes * 8, pad, BlockSize - 18);
