...
namespace HashLib.Crypto.SHA3
{
    ...
    internal abstract class Shabal : HashCryptoNotBuildIn
    {
        #region Consts
        ...
        protected override void TransformBlock(byte[] a_data, int a_index)
        {
            ...
            Converters.ConvertBytesToUInts(a_data, a_index, BlockSize, data, 0);
            ...
            ulong blocks = m_processedBytes / (uint)BlockSize;
        ...
        protected override void Finish()     
        {
            ...
            Converters.ConvertBytesToUInts(m_buffer.GetBytes(), 0, BlockSize, buffer, 0);
            ...
            ulong blocks = m_processedBytes / (ulong)BlockSize + 1;
